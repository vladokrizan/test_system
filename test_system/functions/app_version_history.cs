...
namespace test_system
{
    internal class app_version_history
    {
        ...
        const byte SW_VER_MAJOR = 1;
        const byte SW_VER_MINOR = 0;
        public const string SW_DATE = "7.4.2025";

        public static string sw_version = string.Format("{0}.{1}", SW_VER_MAJOR, SW_VER_MINOR);
