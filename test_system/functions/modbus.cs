...
namespace test_system
{
    internal class modbus
    {
        ...
        /// <returns></returns>
        //=============================================================================================================
        public funReturnCode funModbusRTU_add_byte(byte sendByte, UInt32 SelectComPort)
        {
        ...
        /// <returns></returns>
        //=============================================================================================================
        public funReturnCode funModbusRTU_add_uint16(UInt16 sendWord, UInt32 SelectComPort)
        {
        ...
        /// <returns></returns>
        //=============================================================================================================
        public funReturnCode funModbusRTU_send_request_read_function_3(byte slaveAddress, UInt16 registerAddress, UInt16 numberRegister, UInt32 selectCOMport)
        {

            modbus_start_register_send = registerAddress;
            modbus_register_number_send = numberRegister;
        ...
        //=============================================================================================================
        //=============================================================================================================
        public funReturnCode funModbusRTU_send_request_read_function_4(byte slaveAddress, UInt16 registerAddress, UInt16 numberRegister, UInt32 selectCOMport)
        {
            modbus_start_register_send = registerAddress;
            modbus_register_number_send = numberRegister;
        ...
        */
        ...
        /// <returns></returns>
        //=============================================================================================================
        public funReturnCode funModbusRTU_send_set_single_register_function_6(byte slaveAddress, UInt16 registerAddress, UInt16 setRegister, UInt32 selectCOMport)
        {
        ...
        /// <returns></returns>
        //=============================================================================================================
        public funReturnCode funModbusRTU_send_set_single_register_function_6_KP184(byte slaveAddress, UInt16 registerAddress, UInt32 setRegister, UInt32 selectCOMport)
        {
        ...
        */
        ...
        /// <returns></returns>
        //=======================================================================================================================
        public funReturnCode funModbusRTU_receive_mesasage(int selectCOMport)
        {
            byte selectByte;
            byte loc_loop;
            modbus_register_type_receive = 0;
            modbus_number_register_receive = 0;
            modbus_address_receive = 0;
            ...
            {
                modbus_address_receive = receiveByte_modbus[selectCOMport, 0];
                modbus_register_type_receive = receiveByte_modbus[selectCOMport, 1];
                modbus_number_register_receive = receiveByte_modbus[selectCOMport, 2];
                selectByte = 3;
                for (loc_loop = 0; loc_loop < modbus_number_register_receive; loc_loop++)
                {
