...
{
    public partial class program_10_test_device_test : Form
    {
        ...
        public program_10_test_device_test()
        {
            InitializeComponent();
        }
        ...
        private void program_10_test_supply_multimeeter_Load(object sender, EventArgs e)
        {
            ...
            //-------------------------------------------------------------------------------------------------------------------
            radio_10_01.Text = program10_01;
            radio_10_02.Text = program10_02;
            radio_10_03.Text = program10_03;
            radio_10_04.Text = program10_04;
            radio_10_05.Text = program10_05;
            radio_10_06.Text = program10_06;
            radio_10_07.Text = program10_07;
            radio_10_08.Text = program10_08;
            radio_10_09.Text = program10_09;
            radio_10_10.Text = program10_10;
            radio_10_11.Text = program10_11;
            radio_10_12.Text = program10_12;
            radio_10_08.Checked = true;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radio_10_01.Checked) program10_current_selected_program = program10_01;
            if (radio_10_02.Checked) program10_current_selected_program = program10_02;
            if (radio_10_03.Checked) program10_current_selected_program = program10_03;
            if (radio_10_04.Checked) program10_current_selected_program = program10_04;
            if (radio_10_05.Checked) program10_current_selected_program = program10_05;
            if (radio_10_06.Checked) program10_current_selected_program = program10_06;
            if (radio_10_07.Checked) program10_current_selected_program = program10_07;
            if (radio_10_08.Checked) program10_current_selected_program = program10_08;
            if (radio_10_09.Checked) program10_current_selected_program = program10_09;
            if (radio_10_10.Checked) program10_current_selected_program = program10_10;
            if (radio_10_11.Checked) program10_current_selected_program = program10_11;
            if (radio_10_12.Checked) program10_current_selected_program = program10_12;
            program_10.fun_select_program_log_file_name(program10_current_selected_program);
        ...
        private void fun_program10_start()
        {
            ...
            owon_multimeter.fun_owon_set_range_volt_dc(COMport_XDM3051, XDM_3051_RANGE.DCV___20V);
            owon_multimeter.fun_owon_set_range_volt_dc(COMport_XDM2041, XDM_2041_RANGE.DCV___50V);
            owon_multimeter.fun_owon_set_range_volt_dc(COMport_XDM1041, XDM_1041_RANGE.DCV___50V);
        ...
        private void fun_program10_step()
        {
            ...
            program_common.fun_program___add_log_file___owon_multimeters("Multimeter XDM3051 (V)", "Multimeter XDM2041 (V)", "Multimeter XDM1041 (V)");
            //-------------------------------------------------------------------------------------------------------------------
            ...
            //if (dev_meas_state[COMport_XDM3051] == funReturnCode.OK) program_result_value.Add("Multimeter XDM3051 (V) ", dev_meas[COMport_XDM3051].ToString("0.000"));
            //else
            //{
            //multimeter_XDM3051.fun_XDM3051_measure();
            ...
            //if (dev_meas_state[COMport_XDM2041] == funReturnCode.OK) program_result_value.Add("Multimeter XDM2041 (V) ", dev_meas[COMport_XDM2041].ToString());
            //else
            //{
            // multimeter_XDM2041.fun_XDM2041_measure();
            ...
            //if (dev_meas_state[COMport_XDM1041] == funReturnCode.OK) program_result_value.Add("Multimeter XDM1041 (V) ", dev_meas[COMport_XDM1041].ToString());
            //else
            //{
            //multimeter_XDM1041.fun_XDM1041_measure();
